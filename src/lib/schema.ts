...
export const onboardingSchema = z.object({
  ...
  city_borough: z
    .string()
    .min(1, "City / Borough is required")
    .max(100, "Max 100 characters")
    .regex(cleanTextRegex, cleanTextMsg),
  zip_code: z
    .string()
  ...
  main_address: z
    .string()
    .min(1, "Main Address is required")
    .max(200, "Max 200 characters")
    .regex(cleanTextRegex, cleanTextMsg),
  operating_hours: z
    .array(operatingHoursSlotSchema)
    .min(1, "At least one operating hours slot is required"),
  ...
  pos_system: z
    .string()
    .min(1, "POS System is required")
    .max(100, "Max 100 characters")
    .regex(cleanTextRegex, cleanTextMsg),
  middleware_system: z
    .string()
    .min(1, "Middleware System is required")
    .max(100, "Max 100 characters")
    .regex(cleanTextRegex, cleanTextMsg),
  ...
  contract_name: z
    .string()
    .min(1, "Legal Name for Contract is required")
    .max(100, "Max 100 characters")
    .regex(cleanTextRegex, cleanTextMsg),
  ein_tax_id: z
    .string()
  ...
  authorized_signatory: z
    .string()
    .min(1, "Authorized Signatory is required")
    .max(100, "Max 100 characters")
    .regex(cleanTextRegex, cleanTextMsg),
