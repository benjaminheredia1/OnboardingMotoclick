...
export const template = (data: MotoclickClientOnboardingForm) => {
  ...
  const fieldHalfStyle =
    "width: 47%; margin-bottom: 20px; display: flex; flex-direction: column; border-bottom: 1px solid #eee; padding-bottom: 6px; break-inside: avoid; page-break-inside: avoid;";
  const fieldFullStyle =
    "width: 100%; margin-bottom: 20px; display: flex; flex-direction: column; border-bottom: 1px solid #eee; padding-bottom: 6px; break-inside: avoid; page-break-inside: avoid;";
  const labelStyle =
  ...
  const signatureBlockStyle =
    "margin-top: 60px; display: flex; justify-content: space-between; width: 100%; break-inside: avoid; page-break-inside: avoid;";
