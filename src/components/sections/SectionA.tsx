      ...
      <div className="p-4 bg-white border border-t-0 rounded-b-md shadow-sm space-y-4">
        <FormField control={control} name="legal_name" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="e.g. La Esquina Crioia LLC" maxLength={100} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )} />
        ...
        <FormField control={control} name="dba_name" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="e.g. La Esquina" maxLength={100} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )} />
        ...
        <FormField control={control} name="title_role" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="Owner / Manager / CEO" maxLength={100} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )} />
        ...
        <FormField control={control} name="email_address" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="contact@restaurant.com" type="email" maxLength={100} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )} />
        ...
        <div className="grid grid-cols-[140px_1fr] gap-2">
          <FormField control={control} name="phone_prefix" render={({ field }) => (
            <FormItem>
        ...
        <FormField control={control} name="city_borough" render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="Brooklyn / Manhattan..." maxLength={100} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )} />
